package com.capgemini.bddexample.utils;
...
public class DumpFields {
	public static <T> ArrayList<String> inspectBaseAttribut(Class<T> klazz) {
		...
		while (superClass.getSuperclass() != BaseDAOItem.class
	...
	public static <T extends BaseDAOItem> Object runGetter(Field field, T o) {
	...
	public static <T> ArrayList<String> inspectGetter(Class<T> klazz) {
		...
		try {
			for (PropertyDescriptor propertyDescriptor : Introspector
					.getBeanInfo(klazz, BaseDAOItem.class)
...
//	}
	...
	public static <O extends BaseDAOItem> Class<?> getAssociatedDB(O item) {
